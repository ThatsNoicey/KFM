...
class KFM_Analyzer:
    ...
    def _angle_callback(self, sender, data):
        ...
        try:
            ...
            logging.debug(f"Received angle data: {angle}°")  # Log the raw angle data
            ...
            with self.lock:
                ...
                # print(f"DEBUG: Current angle: {angle}°")  
    ...
    def get_current_data():
        ...
        try:
            with analyzer.lock:
                ...
                # logging.info(f"Current angle in endpoint: {current_angle}")
